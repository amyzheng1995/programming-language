...
public class MapReduceProblemD extends UniversalActor  {
	public static void main(String args[]) {
		...
		MapReduceProblemD instance = (MapReduceProblemD)new MapReduceProblemD(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new MapReduceProblemD(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return MapReduceProblemD.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new MapReduceProblemD(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return MapReduceProblemD.getReferenceByLocation(new UAL(ual)); }
	public MapReduceProblemD(boolean o, UAN __uan)	{ super(false,__uan); }
	public MapReduceProblemD(boolean o, UAL __ual)	{ super(false,__ual); }
	public MapReduceProblemD(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public MapReduceProblemD(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public MapReduceProblemD(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public MapReduceProblemD()		{  }
	public MapReduceProblemD(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "mapreduce.MapReduceProblemD", sourceRef);
			  }
	...
	public UniversalActor construct (MapReduce mr, Vector theaters) {
		Object[] __arguments = { mr, theaters };
	...
	public class State extends UniversalActor .State {
		public MapReduceProblemD self;
		public void updateSelf(ActorReference actorReference) {
			((MapReduceProblemD)actorReference).setUAL(getUAL());
			((MapReduceProblemD)actorReference).setUAN(getUAN());
			self = new MapReduceProblemD(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "mapreduce.MapReduceProblemD$State" );
		...
		Reduce[] reduceActors;
		public void construct(MapReduce mr, Vector theaters){
			kernel = mr;
			mapActors = new Map[mr.nMappers()];
			System.out.println((String)(theaters.get(0)));
			for (int i = 0; i<mapActors.length; ++i)mapActors[i] = ((Map)new Map(new UAN("uan://"+theaters.get(0)+"/map"+i), new UAL("rmsp://"+theaters.get(Math.min((i%theaters.size())+1, theaters.size()-1))),this).construct(mr));
			shuffleActors = new Shuffle[mr.nShufflers()];
			for (int i = 0; i<shuffleActors.length; ++i)shuffleActors[i] = ((Shuffle)new Shuffle(new UAN("uan://"+theaters.get(0)+"/shuf"+i), new UAL("rmsp://"+theaters.get(Math.min((i%theaters.size())+1, theaters.size()-1))),this).construct(mr));
			reduceActors = new Reduce[mr.nReducers()];
			for (int i = 0; i<reduceActors.length; ++i)reduceActors[i] = ((Reduce)new Reduce(new UAN("uan://"+theaters.get(0)+"/redu"+i), new UAL("rmsp://"+theaters.get(Math.min((i%theaters.size())+1, theaters.size()-1))),this).construct(mr));
		}
		public Vector theaterRead(String t) {
...
break;					}
		...
		public void act(String[] args) {
			...
			MapReduceProblemD charCount = ((MapReduceProblemD)new MapReduceProblemD(this).construct(cc, theaters));
