...
public class Map extends UniversalActor  {
	public static void main(String args[]) {
		...
		Map instance = (Map)new Map(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Map(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Map.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Map(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Map.getReferenceByLocation(new UAL(ual)); }
	public Map(boolean o, UAN __uan)	{ super(false,__uan); }
	public Map(boolean o, UAL __ual)	{ super(false,__ual); }
	public Map(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Map(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Map(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Map()		{  }
	public Map(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "mapreduce.Map", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Map)actorReference).setUAL(getUAL());
			((Map)actorReference).setUAN(getUAN());
			self = new Map(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "mapreduce.Map$State" );
