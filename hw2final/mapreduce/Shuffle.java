...
public class Shuffle extends UniversalActor  {
	public static void main(String args[]) {
		...
		Shuffle instance = (Shuffle)new Shuffle(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Shuffle(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Shuffle.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Shuffle(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Shuffle.getReferenceByLocation(new UAL(ual)); }
	public Shuffle(boolean o, UAN __uan)	{ super(false,__uan); }
	public Shuffle(boolean o, UAL __ual)	{ super(false,__ual); }
	public Shuffle(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Shuffle(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Shuffle(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Shuffle()		{  }
	public Shuffle(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "mapreduce.Shuffle", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Shuffle)actorReference).setUAL(getUAL());
			((Shuffle)actorReference).setUAN(getUAN());
			self = new Shuffle(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "mapreduce.Shuffle$State" );
		...
		public void construct(MapReduce mr){
			kernel = mr;
			words = new Vector();
			System.out.println(((Shuffle)self));
		}
