...
public class Reduce extends UniversalActor  {
	public static void main(String args[]) {
		...
		Reduce instance = (Reduce)new Reduce(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Reduce(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Reduce.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Reduce(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Reduce.getReferenceByLocation(new UAL(ual)); }
	public Reduce(boolean o, UAN __uan)	{ super(false,__uan); }
	public Reduce(boolean o, UAL __ual)	{ super(false,__ual); }
	public Reduce(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Reduce(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Reduce(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Reduce()		{  }
	public Reduce(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "mapreduce.Reduce", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Reduce)actorReference).setUAL(getUAL());
			((Reduce)actorReference).setUAN(getUAN());
			self = new Reduce(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "mapreduce.Reduce$State" );
		...
		public void construct(MapReduce mr){
			kernel = mr;
			System.out.println(((Reduce)self));
		}
		public Pair reduce(Pair p) {
			return kernel.reduce(p);
		}
	}
}